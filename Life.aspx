 <%@ Page Title="生活" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Life.aspx.cs" Inherits="MyBookStore.Life" %>
            ...
            <td rowspan="5" style="text-align: center; font-family: 华文楷体; font-weight: bolder;" colspan="3">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="BookId" DataSourceID="LinqDataSource1" Height="384px" PageSize="1" Width="831px">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="BookId" HeaderText="放入购物车" Text="购买" DataNavigateUrlFormatString="~/ShopCart.aspx?BookId={0}" />
                    </Columns>
