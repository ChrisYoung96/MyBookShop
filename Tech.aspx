<%@ Page Title="科技" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Tech.aspx.cs" Inherits="MyBookStore.Tech" %>
    ...
    <table class="nav-justified" style="height: 1056px; width: 1079px;">
        <tr>
            ...
            <td rowspan="5" style="text-align: center; font-family: 华文楷体; font-weight: bolder;" colspan="3">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td rowspan="6" style="width: 204px">
                                            <asp:Image ID="Image7" runat="server" Height="431px" ImageAlign="Middle" ImageUrl='<%# Bind("Image") %>' Width="333px" />
                                        </td>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="MyBookStoreDataContext" EntityTypeName="" TableName="Book" Where="CategoryId == @CategoryId1">
                    <WhereParameters>
                        <asp:Parameter DefaultValue="2" Name="CategoryId1" Type="Int32" />
                    </WhereParameters>
                </asp:LinqDataSource>
            </td>
        </tr>
        ...
        <tr>
            <td style="width: 173px; background-color: #FFFFFF; height: 132px;" class="text-center" rowspan="2"><a href="#" class="btn btn-primary" style="font-family: 华文楷体; font-size: 36px;text-align:center; font-style: normal; font-weight: bold;">工具</a></td>
            <td rowspan="5" style="width: 56px" class="modal-sm">&nbsp;</td>
            <td style="width: 453px" class="text-center">
